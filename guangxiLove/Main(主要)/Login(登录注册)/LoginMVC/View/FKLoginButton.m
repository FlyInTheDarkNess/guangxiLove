...
- (void)fk_createViewForView
{
    ...
    [self setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithHexString:@"#f40002"]] forState:UIControlStateNormal];
    [self setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithHexString:@"#f40002"]] forState:UIControlStateDisabled];
