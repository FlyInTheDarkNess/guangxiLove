...
#import "ZZLFreeWiFiViewController.h"

@interface ZZLFreeWiFiViewController ()

@end

@implementation ZZLFreeWiFiViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = @"免费WiFi";
    ...
    UIImage *image = [UIImage imageNamed:@"free_wifi"];
